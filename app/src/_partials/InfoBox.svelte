<style>.blue_box {
    ...
    <div class="blue_box">
        ...
        <div class="color_box_content">
            <p>
                Mit “normal” meinen wir die Wetterschwankungen der Jahre <strong>1961-1990</strong>.
                Sie waren noch vergleichsweise wenig von der Erderwärmung betroffen und gelten daher
                als offizielle und internationale Vergleichsperiode, um Veränderungen durch den
            ...
            <p>
                Der <strong>graue Bereich</strong> in unseren Diagrammen zeigt also, welches Wetter
                von 1961-1990 am häufigsten war. Wie wir den grauen Bereich genau eingegrenzt haben,
                erfährst du unter <a href="#datengrundlage">Unsere Datengrundlage</a>. Liegt die
                aktuelle Temperatur oder der aktuelle Niederschlag außerhalb des grauen Bereichs,
